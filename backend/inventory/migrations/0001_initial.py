    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='inventory_levels', to='inventory.product')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(limit_choices_to={'is_lotted': True}, on_delete=django.db.models.deletion.CASCADE, related_name='lots', to='inventory.product')),
            ],
            options={
                ...
                'indexes': [models.Index(fields=['product', 'lot_number'], name='inventory_l_product_ac6cbe_idx'), models.Index(fields=['status', 'location'], name='inventory_l_status_689ba4_idx'), models.Index(fields=['expiry_date'], name='inventory_l_expiry__232401_idx')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(limit_choices_to={'is_serialized': True}, on_delete=django.db.models.deletion.CASCADE, related_name='serial_numbers', to='inventory.product')),
            ],
            options={
                'verbose_name': 'Serialized Inventory Item',
                'verbose_name_plural': 'Serialized Inventory Items',
                'ordering': ['product__name', 'serial_number'],
                'indexes': [models.Index(fields=['product', 'serial_number'], name='inventory_s_product_e1d844_idx'), models.Index(fields=['status', 'location'], name='inventory_s_status_8c3059_idx')],
